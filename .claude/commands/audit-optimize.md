...
Ràng buộc bắt buộc (chi tiết & lệnh đo cụ thể nằm ở file trên — bám đúng `quality-supplements.md` Nhóm 2 mục 9 + `existing-project-adoption.md` Bước 2–3 + `CLAUDE.md` §3 mục 10):
