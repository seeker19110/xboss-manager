...
2. **AI góp ý & phản biện (bắt buộc):** Trước khi chốt, AI rà soát toàn bộ và chủ động nêu:
   - Phạm vi MVP có quá lớn không? Nên cắt gì?
   - Schema CSDL có lỗ hổng/thiếu ràng buộc/thiếu index không?
   - Có rủi ro bảo mật nào bị bỏ sót không?
   - Có yêu cầu phi chức năng nào chưa được nói tới không?
   - Trình tự phát triển hợp lý chưa?
